...
nonconstant loop. Example~\ref{ex:quotient-topology-separation} proves scoped
distinctness with a signed-count invariant; that quotient-level argument is
not yet in Lean. The module
...
hypothesis.  The identification with the \emph{subspace} fiber of the global
arrow quotient still depends on the open-map argument in the manuscript.
