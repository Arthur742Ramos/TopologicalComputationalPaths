...
version. A separate Comparator candidate, \LeanName{comparator-roadmap.json},
selects a certificate containing the checked conditional universal,
product, finite global-fiber, and trace-topology results. Its statement
imports the substantive development, and its solution assembles those
proved declarations. It is awaiting Comparator replay and external review.
